...
<body>
	<div id="sellFather" :class="{'fade':buy==1}">
		<div id="top">
		  <span id="topSpan">
		...
		<div id="sell">
			<div id="sellPic">
			    <div :class="{'pshow':p==0}">
					<img src="img/father.jpg" alt="企业精选入职体检套餐【男女通用】" width="360px" height="360px">
				</div>
				<div :class="{'pshow':p==1}">
					<img src="img/father1.jpg" alt="企业精选入职体检套餐【男女通用】" width="360px" height="360px">
				</div>
				<div :class="{'pshow':p==2}">
					<img src="img/father2.jpg" alt="企业精选入职体检套餐【男女通用】" width="360px" height="360px">
				</div>
				<div :class="{'pshow':p==3}">
					<img src="img/fmther.jpg" alt="企业精选入职体检套餐【男女通用】" width="360px" height="360px">
				</div>
				<ul class="clearfix">
					<li>
			...
			<form id="sellInfo" action="/addfa" method="post">
				<h2>父母安享健行体检套餐【男性】</h2>
				<ul class="clearfix">
					<li>在线订购：<font id="f0">￥998.00元 </font></li>
					<li>商城价格：<s>￥2260.00元 </s></li>
					<li>上月订购：1735人</li>
					<li>累计订购：9527人</li>
				</ul>
				<p>
					关爱老人，孝敬父母，主要针对常见肿瘤、心脑血管病、肝病以及血脂异常、糖尿病等慢性生活方式疾病进行健康筛查，尤其适合于长时间坐着不运动、熬夜、高压力人群。 ◎全面的超声检查，全面的生化检查，如肝功，血脂等。 ◎ 肿瘤筛查：有无原发性肝癌，生殖腺胚胎性肿瘤，肝硬化等为广谱肿瘤标志物，可提示直肠癌、结肠癌、肺癌、胰腺癌等。 
				</p>
				<div class="selectt">
					<label>预约日期：</label>
		...
		<div class=" others" id=" others">
			...
			<div :class="{'show':cur==1}">
				<img id="dpic" src="img/fdetail.jpg">
			</div>
